...
Note: as-is this will work just againt the standard configuration with the `NT SERVICE\ADSync` virtual service account. Remember to check if the ADSYnc folder exists before launching it.
